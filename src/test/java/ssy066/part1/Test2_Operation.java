...
public class Test2_Operation extends TestCase {
	...
	public void test2_5_writingPredicates() {
		...
		Predicate o1 = new EQ(v1, 0);
		Predicate o2 = new EQ(v2, true);
		Predicate o12 = new AND(o1, new NOT(o2));

		Predicate o3 = new EQ(v3, "Running");
		Predicate o4 = new EQ(v2, true);
		Predicate o34 = new OR(o3, o4);

		Predicate p1 = new OR(o12, o34);

		assertTrue(p1.toString().equals("((v1 = 0 AND NOT v2 = true) OR (v3 = Running OR v2 = true))"));
	}
