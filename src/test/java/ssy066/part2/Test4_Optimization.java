...
public class Test4_Optimization extends TestCase {
	...
	public void test_find_lowest_cost_path() {
		...
		LinkedList<String> lowestCostPath = new LinkedList<String>();
		lowestCostPath.add("o1");
		lowestCostPath.add("o4");
		lowestCostPath.add("o7");

		System.out.println("found: "+ result.getPath());
		System.out.println("should be: "+ lowestCostPath);

		assertTrue(result.getPath().equals(lowestCostPath));
	}
	...
	public void test_find_shortest_path() {
		...
		assertTrue(result.getPath().equals(shortestPath));
	}
